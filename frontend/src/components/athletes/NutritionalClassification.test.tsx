...
// NutritionalClassification importa el JSON de referencia CDC para calcular Z-scores
...
describe("NutritionalClassification", () => {
  ...
  // 5. Con Z-scores en rango normal muestra "Talla adecuada" y "Adecuado"
  it("con Z-scores en rango normal muestra 'Talla adecuada' y 'Adecuado'", () => {
    render(<NutritionalClassification record={recordNormal} sex="M" birthDate={BIRTH_DATE} />);
    expect(screen.getByText("Talla adecuada")).toBeInTheDocument();
  ...
  // 8. El pie de fuentes incluye "CDC 2000" como texto de la fuente
  it("el pie de fuentes menciona 'CDC 2000'", () => {
    render(<NutritionalClassification record={recordNormal} sex="M" birthDate={BIRTH_DATE} />);
    // El párrafo de fuente dice "Fuente: CDC 2000 / Res. 2465/2016 — MinSalud Colombia"
    expect(screen.getByText(/CDC 2000/)).toBeInTheDocument();
  });
  ...
  it("sin percentiles del backend calcula y muestra clasificación usando referencia CDC", () => {
    render(
      <NutritionalClassification
        record={recordSinPercentiles}
        sex="M"
