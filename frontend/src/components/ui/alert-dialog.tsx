/**
 * AlertDialog — wrapper de `@radix-ui/react-alert-dialog` con tokens de
 * Trocha y Ruta. Base de `ConfirmDialog` (components/shared): a diferencia
 * de `Dialog`, no se cierra al hacer click fuera — exige una acción
 * explícita (Cancelar/Confirmar), el patrón correcto para confirmaciones
 * destructivas.
 */
