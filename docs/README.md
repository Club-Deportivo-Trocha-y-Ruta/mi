...
| 10 | [10-race-results/](10-race-results/) | Resultados Copa Valle XCO: ingesta de PDFs, normalización fuzzy, analíticas longitudinales (evolución, gap podio, ranking club, proyección). Extensión 2026-05-26: condiciones de carrera en UI (wizard + tarjeta tri-estado + PATCH) — ver `upload-design.md` §14 |
