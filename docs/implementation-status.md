...
| Polish | Mandatory privacy audit (T091, `checklists/privacy-audit.md`, **APROBADO** on all 7 points with one fix applied — a raw coach id was leaking into the family session schema); this docs pass (T093/T094 — design/runbook/qa/policy-draft, `technical-notes.md`, this entry); PR description (T098, `specs/041-multi-coach-governance/pr-description.md`) | 🚧 T091/T092/T093/T094/T095/T098 done — T095 verified locally on 2026-09-10 (`pytest -m mysql` 17 passed, offline suite 0 regressions vs `main`, full e2e suite classified against feature 040's baseline); **T096** done except SC-002 (moderated in-person test with the club's coach); **T097** (post-deploy smoke) waits for the owner's merge and deploy |
